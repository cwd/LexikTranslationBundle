 ...
 */
class Version20151015113100 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO FosGroup VALUES(3, 'Backend Access', 'a:19:{i:0;s:1:\"ROLE_BACKEND_ACCESS\"}', '$now', '$now')");
