 ...
 */
class Version20151128114940 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Product (id INT AUTO_INCREMENT NOT NULL, sellPrice NUMERIC(10, 0) DEFAULT \'0\' NOT NULL, basePrice NUMERIC(10, 0) DEFAULT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, state TINYINT(1) DEFAULT \'1\' NOT NULL, origId INT DEFAULT NULL, lifeTime INT DEFAULT NULL, virtual TINYINT(1) DEFAULT \'0\' NOT NULL, updatedAt DATETIME DEFAULT NULL, createdAt DATETIME DEFAULT NULL, supplierId INT DEFAULT NULL, mainImageId INT DEFAULT NULL, createdBy INT UNSIGNED DEFAULT NULL, updatedBy INT UNSIGNED DEFAULT NULL, INDEX IDX_1CF73D31DF05A1D3 (supplierId), INDEX IDX_1CF73D31B9616544 (mainImageId), INDEX IDX_1CF73D31D3564642 (createdBy), INDEX IDX_1CF73D31E8DE7170 (updatedBy), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE MorticianUser (id INT UNSIGNED NOT NULL, morticianId INT NOT NULL, UNIQUE INDEX UNIQ_AF3AA0D7BF396750 (id), INDEX IDX_AF3AA0D788BF07A8 (morticianId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE CustomerAddress (id INT NOT NULL, customer_id INT UNSIGNED DEFAULT NULL, title VARCHAR(200) DEFAULT NULL, `default` TINYINT(1) DEFAULT \'0\', type VARCHAR(255) DEFAULT \'invoice\' NOT NULL, customerId INT NOT NULL, INDEX IDX_2C053519395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE SupplierUser (id INT UNSIGNED NOT NULL, supplierId INT NOT NULL, UNIQUE INDEX UNIQ_F70BC180BF396750 (id), INDEX IDX_F70BC180DF05A1D3 (supplierId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ProductCategory (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, slug VARCHAR(200) NOT NULL, deletedAt DATETIME DEFAULT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, root INT DEFAULT NULL, state TINYINT(1) DEFAULT \'1\' NOT NULL, updatedAt DATETIME DEFAULT NULL, createdAt DATETIME DEFAULT NULL, imageId INT DEFAULT NULL, parentId INT DEFAULT NULL, supplierTypeId INT DEFAULT NULL, createdBy INT UNSIGNED DEFAULT NULL, updatedBy INT UNSIGNED DEFAULT NULL, INDEX IDX_D26EBFC410F3034D (imageId), INDEX IDX_D26EBFC410EE4CEE (parentId), INDEX IDX_D26EBFC4CF7B7F10 (supplierTypeId), INDEX IDX_D26EBFC4D3564642 (createdBy), INDEX IDX_D26EBFC4E8DE7170 (updatedBy), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE CustomerOrder (id INT AUTO_INCREMENT NOT NULL, customer_id INT UNSIGNED DEFAULT NULL, state VARCHAR(255) DEFAULT \'new\' NOT NULL, payedAt DATETIME DEFAULT NULL, deliveredAt DATETIME DEFAULT NULL, paymentReference VARCHAR(255) DEFAULT NULL, totalAmount NUMERIC(6, 2) DEFAULT NULL, customerId INT NOT NULL, deletedAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, createdAt DATETIME DEFAULT NULL, obituaryId INT DEFAULT NULL, createdBy INT UNSIGNED DEFAULT NULL, updatedBy INT UNSIGNED DEFAULT NULL, INDEX IDX_8E2223059395C3F3 (customer_id), INDEX IDX_8E22230568BF794B (obituaryId), INDEX IDX_8E222305D3564642 (createdBy), INDEX IDX_8E222305E8DE7170 (updatedBy), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Admin (id INT UNSIGNED NOT NULL, UNIQUE INDEX UNIQ_49CF2272BF396750 (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
