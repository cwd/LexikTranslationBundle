...
class VtigerImportCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('aspetos:vtiger:organisation:import')
            ->setDescription('Imports Organisations from vTiger')
            /*
            ->addOption(
                'redirect-uri',
                null,
...
EOT
    ...
    {
        $importer = $this->getContainer()->get('aspetos.service.vtiger.importer');
