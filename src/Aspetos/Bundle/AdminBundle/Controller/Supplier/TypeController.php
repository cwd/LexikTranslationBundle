...
class TypeController extends CrudController
{
     ...
     *
     * @param SupplierType $crudObject
     * @param Request      $request
     *
     * @return Response
     */
    public function tabAction(SupplierType $crudObject, Request $request)
    {
        ...
        return $this->render('AspetosAdminBundle:Supplier/Type:' . $template, array('crudObject' => $crudObject));
    }
     ...
     * @return array
     */
    public function detailAction(SupplierType $crudObject)
    {
        return array(
     ...
     */
    public function editAction(SupplierType $crudObject, Request $request)
    {
        $result = $this->formHandler($crudObject, $request, false);
        if ($result instanceof RedirectResponse && $request->get('target', null) == 'self') {
            return $this->redirectToRoute('aspetos_admin_supplier_type_detail', array('id' => $crudObject->getId()));
        }
     ...
     */
    public function deleteAction(SupplierType $crudObject, Request $request)
    {
