...
class MorticianController extends UserController
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->formHandler($object, $request, true, 'aspetos_admin_form_user_mortician', 'Mortician');
    }
    ...
    {
        return $this->formHandler($user, $request, false, 'aspetos_admin_form_user_mortician', 'Mortician');
    }
}
