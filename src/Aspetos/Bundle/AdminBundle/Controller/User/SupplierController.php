...
class SupplierController extends UserController
{
    ...
    {
        $object = new SupplierUser();

        return $this->formHandler($object, $request, true, 'aspetos_admin_form_user_supplier', 'Supplier');
    }
    ...
    {
        return $this->formHandler($user, $request, false, 'aspetos_admin_form_user_supplier', 'Supplier');
    }
}
