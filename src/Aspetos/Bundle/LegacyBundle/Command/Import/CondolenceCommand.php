 ...
 */
class CondolenceCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('aspetos:legacy:import:condolence')
            ->setDescription('Imports condolences from Legacy Database')
            ->addOption(
                'offset',
                null,
