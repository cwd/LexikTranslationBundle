 ...
 *
 * @DI\Service("aspetos.legacy.grid.company")
 */
class Company extends Grid
{
    ...
    public function get()
    {
        ...
        $datatable
            ...
            ->setWhere('x.userCategory = :type', array('type' => 'company'))
            ->setFields(
                array(
                    'UID' => 'x.uid as xid',
                    'Country' => 'x.domain',
            ...
            ->setRenderers(
                array(
                    10 => array(
                        ...
                        'params' => array(
                            'view_route'     => 'aspetos_legacy_company_detail',
                            'edit_route'     => 'aspetos_legacy_company_edit',
                            //'delete_route'   => 'aspetos_legacy_company_delete',
                            //'undelete_route' => 'aspetos_legacy_company_undelete',
                        ),
                    ),
                )
            )
