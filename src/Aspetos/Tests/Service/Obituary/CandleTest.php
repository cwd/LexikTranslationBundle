 ...
 */
class CandleTest extends DoctrineTestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->service = $this->container->get('aspetos.service.obituary.candle');
    }
    ...
    public function testFind()
    {
        ...
        $this->setExpectedException('\Aspetos\Service\Exception\CandleNotFoundException');
