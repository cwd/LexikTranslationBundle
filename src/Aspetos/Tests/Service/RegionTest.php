...
/**
 * Class Aspetos\RegionTest
 *
 * @package Aspetos\Tests\Service
 * @author  Ludwig Ruderstaller <lr@cwd.at>
 */
class RegionTest extends DoctrineTestCase
{
    /**
     * @var \Aspetos\Service\Region
     */
    protected $service;
    ...
    public function setUp()
    {
        ...
        $this->service = $this->container->get('aspetos.service.region');
    }
    ...
    public function testFind()
    {
        ...
        $this->setExpectedException('\Aspetos\Service\Exception\RegionNotFoundException');
